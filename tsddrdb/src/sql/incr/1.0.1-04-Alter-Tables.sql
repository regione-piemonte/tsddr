ALTER TABLE tsddr_t_rifiuti_tariffe ALTER COLUMN importo TYPE NUMERIC(10,8);

ALTER TABLE tsddr_t_conferimenti ALTER COLUMN quantita TYPE NUMERIC(14,4);

ALTER TABLE tsddr_t_conferimenti ALTER COLUMN importo TYPE NUMERIC(12,2);
