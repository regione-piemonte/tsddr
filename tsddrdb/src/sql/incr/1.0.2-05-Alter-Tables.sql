...
UPDATE TSDDR_T_REPORT_DETT set TESTO = 'MOD. TS-MR-D-2019' where ID_DETTAGLIO=63;
UPDATE TSDDR_T_REPORT_DETT set TESTO = 'PAGAMENTO IN MISURA RIDOTTA DICHIARAZIONE DI CONSEGUIMENTO DEGLI OBIETTIVI' where ID_DETTAGLIO=66;