...
<jasperReport xmlns="http://jasperreports.sourceforge.net/jasperreports" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://jasperreports.sourceforge.net/jasperreports http://jasperreports.sourceforge.net/xsd/jasperreport.xsd" name="UMA_MODELLO_26_V" pageWidth="595" pageHeight="900" columnWidth="555" leftMargin="20" rightMargin="20" topMargin="20" bottomMargin="20" whenResourceMissingType="Error" uuid="3e2d4fe0-be96-423a-93be-f74048f83696">
	...
	<title>
		<band height="860" splitType="Stretch">
			...
			<textField textAdjust="ScaleFont">
				<reportElement x="162" y="0" width="234" height="34" uuid="b417a835-96fb-4f27-9438-594ff717a10d">
					<property name="com.jaspersoft.studio.unit.x" value="pixel"/>
					<property name="com.jaspersoft.studio.unit.y" value="px"/>
				</reportElement>
			...
			<textField textAdjust="StretchHeight">
				<reportElement x="162" y="34" width="234" height="19" uuid="b07ca9f8-9b3c-49d3-8014-d6a3a045be4f">
					<property name="com.jaspersoft.studio.unit.x" value="pixel"/>
					<property name="com.jaspersoft.studio.unit.y" value="px"/>
				</reportElement>
				<textElement textAlignment="Center" verticalAlignment="Top">
			...
			<componentElement>
				...
				<jr:list xmlns:jr="http://jasperreports.sourceforge.net/jasperreports/components" xsi:schemaLocation="http://jasperreports.sourceforge.net/jasperreports/components http://jasperreports.sourceforge.net/xsd/components.xsd" printOrder="Vertical" ignoreWidth="true">
					...
					<jr:listContents height="28" width="569">
						...
						<textField textAdjust="ScaleFont">
							<reportElement key="" mode="Opaque" x="103" y="2" width="356" height="10" backcolor="#FFFFFF" uuid="8543b2cf-6873-4a19-ac0a-1e2ac820e803">
								<property name="com.jaspersoft.studio.unit.x" value="px"/>
								<property name="com.jaspersoft.studio.unit.y" value="px"/>
							</reportElement>
							<box leftPadding="5">
						...
						<textField textAdjust="ScaleFont" pattern="#,##0.########;#,##0.########-">
							<reportElement key="" mode="Opaque" x="50" y="2" width="50" height="10" backcolor="#FFFFFF" uuid="61a4964e-a18d-41ed-8f55-c345259aeb89">
								<property name="com.jaspersoft.studio.unit.x" value="px"/>
								<property name="com.jaspersoft.studio.unit.y" value="px"/>
							</reportElement>
							<box>
			...
			<staticText>
				<reportElement positionType="Float" x="484" y="538" width="65" height="12" backcolor="#71B2DE" uuid="19420d99-4dba-44a0-b2e3-9df8771aceb4">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
				</reportElement>
				<box>
					<topPen lineWidth="1.0" lineStyle="Solid" lineColor="#000000"/>
			...
			<staticText>
				<reportElement positionType="Float" x="484" y="550" width="65" height="12" backcolor="#71B2DE" uuid="5642bf9f-fafb-42ad-86af-f58c7b4d44aa">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
				</reportElement>
				<box>
			...
			<textField textAdjust="ScaleFont" pattern="#,##0.###;#,##0.###-">
				<reportElement key="" positionType="Float" x="484" y="562" width="65" height="12" backcolor="#E0E0E0" uuid="e94f8fb2-57ef-4aaa-ad7f-99870d564df9">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
				</reportElement>
				<box>
			...
			<componentElement>
				<reportElement positionType="Float" x="4" y="562" width="96" height="14" uuid="1d249bfe-2a9c-4cda-9fe0-2f50597c12a5">
					<property name="net.sf.jasperreports.export.headertoolbar.table.name" value="Soggetti"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.CONTENTS.height" value="px"/>
				...
				<jr:list xmlns:jr="http://jasperreports.sourceforge.net/jasperreports/components" xsi:schemaLocation="http://jasperreports.sourceforge.net/jasperreports/components http://jasperreports.sourceforge.net/xsd/components.xsd" printOrder="Horizontal" ignoreWidth="true">
					<datasetRun subDataset="versamentiDataset" uuid="f77ec0ff-88f8-40a4-bfcc-80a48edcf306">
						<dataSourceExpression><![CDATA[$P{versamenti}]]></dataSourceExpression>
					</datasetRun>
					<jr:listContents height="14" width="96">
						<textField textAdjust="ScaleFont" pattern="dd/MM/yyyy" isBlankWhenNull="true">
							<reportElement key="" x="0" y="0" width="45" height="12" backcolor="#E0E0E0" uuid="127d394e-1015-49c2-b537-f392b9c13286">
								<property name="com.jaspersoft.studio.unit.width" value="px"/>
								<property name="com.jaspersoft.studio.unit.height" value="px"/>
								<property name="com.jaspersoft.studio.unit.y" value="px"/>
								<property name="com.jaspersoft.studio.unit.x" value="px"/>
						...
						<textField textAdjust="ScaleFont" pattern="#,##0.###;#,##0.###-">
							<reportElement key="" x="45" y="0" width="45" height="12" backcolor="#E0E0E0" uuid="22e70167-b9f0-4610-a22f-4e1cacc9f3cc">
								<property name="com.jaspersoft.studio.unit.width" value="px"/>
								<property name="com.jaspersoft.studio.unit.height" value="px"/>
								<property name="com.jaspersoft.studio.unit.y" value="px"/>
								<property name="com.jaspersoft.studio.unit.x" value="px"/>
