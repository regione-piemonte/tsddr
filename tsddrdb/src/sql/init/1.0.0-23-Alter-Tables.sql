...
<jasperReport xmlns="http://jasperreports.sourceforge.net/jasperreports" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://jasperreports.sourceforge.net/jasperreports http://jasperreports.sourceforge.net/xsd/jasperreport.xsd" name="UMA_MODELLO_26_V" pageWidth="595" pageHeight="842" columnWidth="555" leftMargin="20" rightMargin="20" topMargin="20" bottomMargin="20" whenResourceMissingType="Error" uuid="3e2d4fe0-be96-423a-93be-f74048f83696">
	...
	<title>
		<band height="802" splitType="Stretch">
			...
			<rectangle>
				<reportElement positionType="Float" x="1" y="491" width="560" height="16" uuid="dd3c4230-91f8-47e8-aede-f536d45cfd5a">
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
				</reportElement>
				<graphicElement>
					<pen lineColor="#71B2DE"/>
				</graphicElement>
			</rectangle>
			<staticText>
			...
			<componentElement>
				...
				<jr:list xmlns:jr="http://jasperreports.sourceforge.net/jasperreports/components" xsi:schemaLocation="http://jasperreports.sourceforge.net/jasperreports/components http://jasperreports.sourceforge.net/xsd/components.xsd" printOrder="Vertical" ignoreWidth="true">
					...
					<jr:listContents height="28" width="569">
						<rectangle>
							<reportElement stretchType="ContainerHeight" x="0" y="0" width="560" height="28" backcolor="#2FEDED" uuid="a39497d8-af5a-4a4b-882f-00acdea8c1e1">
								<property name="com.jaspersoft.studio.unit.width" value="px"/>
								<property name="com.jaspersoft.studio.unit.height" value="px"/>
							</reportElement>
							<graphicElement>
						...
						<textField textAdjust="ScaleFont">
							...
							<textFieldExpression><![CDATA[$F{rifiutoTariffa.descrizione}]]></textFieldExpression>
						</textField>
						<textField textAdjust="ScaleFont">
						...
						<textField textAdjust="ScaleFont">
							<reportElement key="" mode="Opaque" x="530" y="2" width="20" height="10" backcolor="#FFFFFF" uuid="628964a0-c723-43c1-adb8-900be6becccd">
								<property name="com.jaspersoft.studio.unit.x" value="px"/>
								<property name="com.jaspersoft.studio.unit.y" value="px"/>
							</reportElement>
							<box>
							...
							<textFieldExpression><![CDATA[$F{rifiutoTariffa.flagRiduzione}]]></textFieldExpression>
						</textField>
						<staticText>
			...
			<componentElement>
				<reportElement positionType="Float" x="16" y="493" width="110" height="14" uuid="7b1807ae-49fc-40d5-87a3-cf31a51afa80">
					<property name="net.sf.jasperreports.export.headertoolbar.table.name" value="Soggetti"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.CONTENTS.height" value="px"/>
			...
			<textField textAdjust="ScaleFont">
				<reportElement key="" positionType="Float" x="505" y="493" width="50" height="12" backcolor="#E0E0E0" uuid="157a3b95-24ed-41b1-819b-2b18d902b160">
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.y" value="px"/>
					<property name="com.jaspersoft.studio.unit.x" value="px"/>
			...
			<textField textAdjust="ScaleFont">
				<reportElement key="" positionType="Float" x="455" y="493" width="50" height="12" backcolor="#E0E0E0" uuid="ebbedd06-2b54-4c97-a51c-43680625fca5">
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.y" value="px"/>
					<property name="com.jaspersoft.studio.unit.x" value="px"/>
			...
			<textField textAdjust="ScaleFont" isBlankWhenNull="true">
				<reportElement key="" positionType="Float" x="5" y="510" width="544" height="15" uuid="8cb99f14-20c0-4e03-bc7f-90ddfef43026"/>
				<box>
					<topPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<leftPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<bottomPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
			...
			<staticText>
				<reportElement positionType="Float" x="4" y="528" width="90" height="12" backcolor="#FFFFFF" uuid="a79b060e-3e11-4aeb-b17d-67d4e4cf64be">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
				</reportElement>
				<box>
			...
			<staticText>
				<reportElement positionType="Float" x="4" y="540" width="45" height="12" backcolor="#FFFFFF" uuid="0a2c1c85-84b2-45da-ab59-8fdfee08cc21">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
				</reportElement>
				<box>
			...
			<staticText>
				<reportElement positionType="Float" x="49" y="540" width="45" height="12" backcolor="#FFFFFF" uuid="829f81de-eb5e-4131-82b7-529032bc6def">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
				</reportElement>
				<box>
			...
			<staticText>
				<reportElement positionType="Float" x="100" y="528" width="90" height="12" backcolor="#FFFFFF" uuid="8924e44f-d86f-41e5-a31c-71f493bc4090">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.x" value="px"/>
				</reportElement>
			...
			<staticText>
				<reportElement positionType="Float" x="100" y="540" width="45" height="12" backcolor="#FFFFFF" uuid="04add084-7347-44de-9856-66ffbafc79ef">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.x" value="px"/>
				</reportElement>
			...
			<staticText>
				<reportElement positionType="Float" x="145" y="540" width="45" height="12" backcolor="#FFFFFF" uuid="16053d5c-69fa-4c6f-aa1c-bbfb5eddd6f6">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.x" value="px"/>
				</reportElement>
			...
			<staticText>
				<reportElement positionType="Float" x="196" y="528" width="90" height="12" backcolor="#FFFFFF" uuid="ff8f9349-c666-40d3-ac48-00f619c3c9d3">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.x" value="px"/>
				</reportElement>
			...
			<staticText>
				<reportElement positionType="Float" x="196" y="540" width="45" height="12" backcolor="#FFFFFF" uuid="626d97ce-6d37-489e-8160-a7f89a0b396b">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.x" value="px"/>
				</reportElement>
			...
			<staticText>
				<reportElement positionType="Float" x="241" y="540" width="45" height="12" backcolor="#FFFFFF" uuid="f61233bd-19ca-418c-97c4-e45f5e957c91">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.x" value="px"/>
				</reportElement>
			...
			<staticText>
				<reportElement positionType="Float" x="292" y="528" width="90" height="12" backcolor="#FFFFFF" uuid="9b64900b-6587-41a9-a908-a96ee1616fc4">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.x" value="px"/>
				</reportElement>
			...
			<staticText>
				<reportElement positionType="Float" x="292" y="540" width="45" height="12" backcolor="#FFFFFF" uuid="2a7abe41-f01c-438f-9ad6-b5be3aa0acd3">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.x" value="px"/>
				</reportElement>
			...
			<staticText>
				<reportElement positionType="Float" x="337" y="540" width="45" height="12" backcolor="#FFFFFF" uuid="ed57e3f4-c0dd-4c55-b05f-bc4661e93b1f">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.x" value="px"/>
				</reportElement>
			...
			<staticText>
				<reportElement positionType="Float" x="483" y="528" width="65" height="12" backcolor="#71B2DE" uuid="19420d99-4dba-44a0-b2e3-9df8771aceb4">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
				</reportElement>
				<box>
					<topPen lineWidth="1.0" lineStyle="Solid" lineColor="#000000"/>
			...
			<staticText>
				<reportElement positionType="Float" x="483" y="540" width="65" height="12" backcolor="#71B2DE" uuid="5642bf9f-fafb-42ad-86af-f58c7b4d44aa">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
				</reportElement>
				<box>
			...
			<staticText>
				<reportElement positionType="Float" x="388" y="528" width="90" height="12" backcolor="#FFFFFF" uuid="4854717f-3f5c-4928-9033-d7e123fb964d">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.x" value="px"/>
				</reportElement>
			...
			<staticText>
				<reportElement positionType="Float" x="388" y="540" width="45" height="12" backcolor="#FFFFFF" uuid="b115c353-c55d-4786-bbb5-8cafab51ed78">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.x" value="px"/>
				</reportElement>
			...
			<staticText>
				<reportElement positionType="Float" x="433" y="540" width="45" height="12" backcolor="#FFFFFF" uuid="db41d014-ad04-4ee8-b434-159cf50461e1">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.x" value="px"/>
				</reportElement>
			...
			<textField textAdjust="ScaleFont">
				<reportElement key="" positionType="Float" x="483" y="552" width="65" height="12" backcolor="#E0E0E0" uuid="e94f8fb2-57ef-4aaa-ad7f-99870d564df9">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
				</reportElement>
				<box>
			...
			<staticText>
				<reportElement positionType="Float" x="142" y="567" width="195" height="12" backcolor="#FFFFFF" uuid="37a9bfe9-a805-4673-8a54-f59d9652712d">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
			...
			<textField textAdjust="ScaleFont">
				<reportElement key="" positionType="Float" x="343" y="567" width="71" height="12" backcolor="#E0E0E0" uuid="d69ec5c3-ee93-4529-9436-928371523843">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
			...
			<textField textAdjust="ScaleFont">
				<reportElement key="" positionType="Float" x="343" y="581" width="71" height="12" backcolor="#E0E0E0" uuid="fe11c48f-eb85-475d-bfa8-ebed99e535d6">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.rightIndent" value="px"/>
				</reportElement>
				<box>
			...
			<staticText>
				<reportElement positionType="Float" x="142" y="581" width="195" height="12" backcolor="#FFFFFF" uuid="f3110847-2884-4dbd-a8f8-07ee88a732d5">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.leftIndent" value="px"/>
				</reportElement>
			...
			<staticText>
				<reportElement positionType="Float" x="142" y="595" width="195" height="12" backcolor="#FFFFFF" uuid="b97140bd-24cf-433c-8cc1-e375d9977cce">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.leftIndent" value="px"/>
				</reportElement>
			...
			<textField textAdjust="ScaleFont">
				<reportElement key="" positionType="Float" x="343" y="595" width="71" height="12" backcolor="#E0E0E0" uuid="2446e427-17dd-4bed-a799-a906789a8a88">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.rightIndent" value="px"/>
				</reportElement>
				<box>
			...
			<staticText>
				<reportElement positionType="Float" x="142" y="609" width="195" height="15" backcolor="#FFFFFF" uuid="243cb2d3-5f36-4f64-bad5-a9c21b6a8d20">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.leftIndent" value="px"/>
				</reportElement>
			...
			<textField textAdjust="ScaleFont" pattern="0,00" isBlankWhenNull="true">
				<reportElement key="" positionType="Float" x="343" y="609" width="71" height="15" backcolor="#E0E0E0" uuid="186c5765-86c4-419a-88f4-a16bade0200d">
					<property name="com.jaspersoft.studio.unit.rightIndent" value="px"/>
				</reportElement>
				<box>
					<topPen lineWidth="1.0" lineStyle="Solid" lineColor="#000000"/>
			...
			<componentElement>
				<reportElement positionType="Float" x="4" y="552" width="96" height="14" uuid="30054741-0a8d-4ac4-869f-dfa1fad31c89">
					<property name="net.sf.jasperreports.export.headertoolbar.table.name" value="Soggetti"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.CONTENTS.height" value="px"/>
			...
			<rectangle>
				<reportElement positionType="Float" x="0" y="630" width="555" height="2" backcolor="#000000" uuid="7a00e85e-7b0d-4760-8f52-a34f93dccb95">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
				</reportElement>
			</rectangle>
			<textField textAdjust="ScaleFont">
				<reportElement key="" positionType="Float" x="5" y="636" width="544" height="15" backcolor="#E0E0E0" uuid="758605f9-3fdd-4a67-9ec7-d7f1ea30ea90">
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
				</reportElement>
			...
			<textField textAdjust="ScaleFont">
				<reportElement key="" positionType="Float" x="5" y="725" width="544" height="10" backcolor="#E0E0E0" uuid="758605f9-3fdd-4a67-9ec7-d7f1ea30ea90">
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
				</reportElement>
				<textElement textAlignment="Left" verticalAlignment="Middle">
			...
			<staticText>
				<reportElement positionType="Float" x="5" y="736" width="26" height="10" backcolor="#FFFFFF" uuid="8be1c054-3684-4186-96e4-c62297effec2">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
				</reportElement>
				<box>
					<topPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
			...
			<textField textAdjust="ScaleFont" pattern="dd/MM/yyyy">
				<reportElement key="" positionType="Float" x="31" y="736" width="117" height="10" backcolor="#E0E0E0" uuid="758605f9-3fdd-4a67-9ec7-d7f1ea30ea90">
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
				</reportElement>
				<box>
			...
			<textField textAdjust="ScaleFont">
				<reportElement key="" positionType="Float" x="5" y="746" width="544" height="10" backcolor="#E0E0E0" uuid="758605f9-3fdd-4a67-9ec7-d7f1ea30ea90">
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
				</reportElement>
				<textElement textAlignment="Left" verticalAlignment="Middle">
			...
			<rectangle>
				<reportElement positionType="Float" x="-1" y="756" width="555" height="2" backcolor="#000000" uuid="b1b28746-ca42-4cbc-9886-d6ec846a2cb8">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
				</reportElement>
			</rectangle>
			<textField textAdjust="ScaleFont">
				<reportElement key="" positionType="Float" x="4" y="758" width="544" height="10" backcolor="#E0E0E0" uuid="758605f9-3fdd-4a67-9ec7-d7f1ea30ea90">
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
				</reportElement>
			...
			<textField textAdjust="ScaleFont">
				<reportElement key="" positionType="Float" x="4" y="768" width="544" height="34" backcolor="#E0E0E0" uuid="758605f9-3fdd-4a67-9ec7-d7f1ea30ea90">
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
				</reportElement>
				<textElement textAlignment="Left" verticalAlignment="Middle">
			...
			<rectangle>
				<reportElement positionType="Float" x="0" y="723" width="555" height="2" backcolor="#000000" uuid="2d4f6fa3-1319-46e5-b7f7-6141c3a673b8">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
				</reportElement>
			</rectangle>
			<textField textAdjust="ScaleFont">
				<reportElement key="" positionType="Float" x="4" y="680" width="544" height="15" backcolor="#E0E0E0" uuid="758605f9-3fdd-4a67-9ec7-d7f1ea30ea90">
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
				</reportElement>
				<textElement textAlignment="Left" verticalAlignment="Middle">
			...
			<textField textAdjust="ScaleFont" isBlankWhenNull="true">
				<reportElement key="" positionType="Float" stretchType="ElementGroupHeight" x="4" y="695" width="545" height="24" backcolor="#E0E0E0" uuid="5dcfbbdc-2a3f-416f-a74e-70e1cbac4013">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.rightIndent" value="px"/>
				</reportElement>
				<box>
			...
			<staticText>
				<reportElement positionType="Float" x="101" y="650" width="35" height="12" backcolor="#FFFFFF" uuid="65eae63e-c83c-4a72-928f-ac8e4ab06c75">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.rightIndent" value="pixel"/>
					<property name="com.jaspersoft.studio.unit.leftIndent" value="px"/>
			...
			<staticText>
				<reportElement positionType="Float" x="136" y="650" width="115" height="12" backcolor="#FFFFFF" uuid="7bf73120-669e-40a7-a6d4-09c97fcc070d">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.rightIndent" value="pixel"/>
					<property name="com.jaspersoft.studio.unit.leftIndent" value="px"/>
			...
			<staticText>
				<reportElement positionType="Float" x="251" y="650" width="134" height="12" backcolor="#FFFFFF" uuid="8fd29b4e-7a3d-4212-af90-d1e2a3cfea9c">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.rightIndent" value="pixel"/>
					<property name="com.jaspersoft.studio.unit.leftIndent" value="px"/>
			...
			<staticText>
				<reportElement positionType="Float" x="385" y="650" width="77" height="12" backcolor="#FFFFFF" uuid="a0c35f16-52a3-4af2-a048-c03a4ff7030e">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.rightIndent" value="pixel"/>
					<property name="com.jaspersoft.studio.unit.leftIndent" value="px"/>
			...
			<staticText>
				<reportElement positionType="Float" x="101" y="662" width="35" height="12" backcolor="#FFFFFF" uuid="cdbc5418-2a77-4622-9a40-a63c57028277">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.rightIndent" value="pixel"/>
					<property name="com.jaspersoft.studio.unit.leftIndent" value="px"/>
			...
			<staticText>
				<reportElement positionType="Float" x="136" y="662" width="115" height="12" backcolor="#FFFFFF" uuid="f80831f2-d8fd-421a-8f0a-d7cc9d3b4667">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.rightIndent" value="pixel"/>
					<property name="com.jaspersoft.studio.unit.leftIndent" value="px"/>
			...
			<staticText>
				<reportElement positionType="Float" x="251" y="662" width="134" height="12" backcolor="#FFFFFF" uuid="f333d1e7-0bc0-430a-8364-5d2fee1366d2">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.rightIndent" value="pixel"/>
					<property name="com.jaspersoft.studio.unit.leftIndent" value="px"/>
			...
			<staticText>
				<reportElement positionType="Float" x="385" y="662" width="77" height="12" backcolor="#FFFFFF" uuid="cbaff7fb-4b9e-4355-9e55-f0624846faf0">
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.rightIndent" value="pixel"/>
					<property name="com.jaspersoft.studio.unit.leftIndent" value="px"/>
			...
			<componentElement>
				<reportElement positionType="Float" stretchType="ElementGroupHeight" x="101" y="662" width="361" height="12" uuid="07d3356b-c8ec-49b6-a79a-fbd2d94e9e54">
					<property name="net.sf.jasperreports.export.headertoolbar.table.name" value="Soggetti"/>
					<property name="com.jaspersoft.studio.unit.width" value="px"/>
					<property name="com.jaspersoft.studio.unit.height" value="px"/>
					<property name="com.jaspersoft.studio.unit.CONTENTS.height" value="px"/>
