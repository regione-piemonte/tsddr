...
export const environment: any = {
  ...
  // il logout chiama prima il logout del BE widfly poi alla risposta effettua la logout sso alla url qui configurate
    ...
    //ssoLogoutFO: 'https://ts-tsddr.regione.piemonte.it/tsddr_int_443s_liv3_sispliv2spid_gasp_regione/logout.do'
    ssoLogoutFO: 'https://ts-tsddr.regione.piemonte.it/ts_tsddr_int_443s_liv3_sispliv2spid_gasp_regione/logout.do'
  },
  fakeAuth: {
    enabled: false,
    header: {
