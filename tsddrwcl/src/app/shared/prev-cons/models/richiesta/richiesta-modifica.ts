...
import {
  IPrevCons,
  IStatusMrFormEditingStore
} from '../../interfaces/prev-cons.interface';
import {
  PrevConsEditAbstract,
  IPath
} from '../abstract-factory/prev-cons-edit-abstract';
...
export class RichiestaModifica extends PrevConsEditAbstract {
  public isEditMode: boolean = true;
  public helperTitle: string;
  public profiloACL: IProfiloACL;
  public path: IPath = 'richieste-mr/lista';
  ...
  //Pulsante invio dichiarazione
  public btnInserisciMr: string = 'RICHIESTA_MR.CREATE.FORM.BUTTON';
  public ariaLabelInserisci: string = 'Invia nuova richiesta MR';
  ...
  public setHelperTitle(value: string): void {
    // da documentazione non sembra esserci la nota info nè in modifica nè in visualizza
